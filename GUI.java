    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                ...
                gui.queueTime.setText(String.format("Queue Average Response Time: %.2f microseconds", Queue.getAverageResponseTime()));
                gui.queueTime.append(String.format("\nQueue Average Turnaround Time: %.2f microseconds", Queue.getAverageTurnaroundTime()));

                gui.lifoText.setText(LLLIFO.executeTasksLLLIFO());
                gui.lifoTime.setText(String.format("LL LIFO Average Response Time: %.2f microseconds", LLLIFO.getAverageResponseTime()));
                gui.lifoTime.append(String.format("\nLL LIFO Average Turnaround Time: %.2f microseconds", LLLIFO.getAverageTurnaroundTime()));

                gui.fifoText.setText(LLFIFO.executeTasksLLFIFO()); 
                gui.fifoTime.setText(String.format("LL FIFO Average Response Time: %.2f microseconds", LLFIFO.getAverageResponseTime()));
                gui.fifoTime.append(String.format("\nLL FIFO Average Turnaround Time: %.2f microseconds", LLFIFO.getAverageTurnaroundTime()));

                gui.stackText.setText(Stack.executeTasksStack()); 
                gui.stackTime.setText(String.format("Stack Average Response Time: %.2f microseconds", Stack.getAverageResponseTime()));
                gui.stackTime.append(String.format("\nStack Average Turnaround Time: %.2f microseconds", Stack.getAverageTurnaroundTime()));
            }
        });
    }
